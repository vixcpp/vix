...
- [x] Detect `public/`.
- [x] Serve static files easily.
- [x] Support cache headers.
- [x] Support static file compression later.
- [x] Support HTTP compression for backend responses.
- [x] Support SPA fallback.
- [x] Support public asset diagnostics.
- [x] Warn when public files are missing.
- [x] Add backend template with static UI.
