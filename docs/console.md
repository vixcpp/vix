...
int main() {
  ...
  vix::console.info("Server started on", 8080);
  vix::console.warn("Deprecated API used:", "/v1/users");
  vix::console.error("Crash detected:", "segfault");
  vix::console.debug("x =", 42); // debug is OFF by default
}
```
