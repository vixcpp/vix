...
It is available for testing and design feedback, but it is not production-ready yet.
The file format, fields, generated CMake behavior, and registry dependency integration may change before stabilization.
:::
